...
from python_code.detectors.modular_bayesian_viterbinet.bayesian_viterbinet_trainer import BayesianVNETTrainer
...
CHANNEL_TYPE_TO_TRAINER_DICT = {
    ...
    DetectorType.bayesian_deepsic.name: ModularBayesianDeepSICTrainer,
    ...
    DetectorType.bayesian_viterbinet.name: BayesianVNETTrainer
}
